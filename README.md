...
Exotic and luxury car rental platform — Next.js 15, React 19, TypeScript,
Tailwind CSS 4.
...
Requires Node 20+ and pnpm 10. `pnpm-workspace.yaml` sets a one-day
`minimumReleaseAge` on npm installs as a supply-chain safeguard — leave it in
place.
